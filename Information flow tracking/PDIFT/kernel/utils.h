...
extern std::string mod_policy_index;

YOSYS_NAMESPACE_BEGIN
extern RTLIL::IdString mod_flag;
extern RTLIL::IdString loop_front;
extern RTLIL::IdString express_end;
extern vector<std::set<RTLIL::SigSig>> mod_policy;

//if dict not , try vector<std::set<RTLIL::SIgsSIg>>
