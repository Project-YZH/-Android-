...
//#include "pass/modift/DesignMap.cc"
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
//////////////////////////////////////////////////////////////////////////
		printf("===========gather the mod information of each cell============\n");
		for(auto &mod_iter : design->modules_)
		{	
			RTLIL::Module* module = mod_iter.second;
			printf("The mod is %s :\n", log_id(mod_iter.first));
			SigMap SigMap(mod_iter.second);
			printf("please enter the type of mod \n");
			scanf("%s",type);	
//////////////////////////////////////////////////////////////////////////////////////////////////////////
			//instrument all cell of specific module
			for(auto cell_iter : mod_iter.second->cells_)
			{
				cell_iter.second->set_string_attribute(mod_name,mod_iter.second->name.str().substr(1));
				string a = cell_iter.second->get_string_attribute(mod_name).substr(1);
				cell_iter.second->set_string_attribute(mod_type,type);
				string b = cell_iter.second->get_string_attribute(mod_type);
				string c = log_id(cell_iter.second->name);
			}

			
//////////////////////////////////////////////////////////////////////////////////////////////////////////
			
			//only instrument the cell of edge of specific module 
			CellTypes ct;
			ct.setup_internals();
			ct.setup_stdcells();
